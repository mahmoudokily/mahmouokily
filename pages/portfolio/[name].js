                ...
                >
                    ...
                    <div className={styles.images}>
                        <div className={styles.full_img}>
                            ...
                            >
                                <img src={mob ? project.mVedio : project.dVedio} alt="" className={styles.imgg}
                                     id='img'/>
                            </motion.div>
                        </div>
                        <div className={styles.control}>
                            ...
                            <button className={styles.zoom} onClick={zoomMe}> {zoomIn ? <AiOutlineZoomIn/> :
                                <AiOutlineZoomOut/>}</button>
                        </div>
                    </div>
                </motion.div>
            }
