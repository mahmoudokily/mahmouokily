                ...
                <div className={styles.scorll}>
                    <div className={styles.right_head}>
                        ...
                        <div className={styles.p}>
                            See my works below. Unless explicitly stated otherwise, all their back-end and front-end
                            parts were completely done by me.

                        </div>
                        <div className={styles.call_me}>
                            Currently open to co-operation on new and existing projects.
                            Looking for a CTO, a mentor, or a just full-stack dev willing to join your team?
